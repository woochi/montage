...
<section id="page">
  <article class="column-row">
    <div class="container col-1 centered">
      <p class="lead">Montaasissa on tehty vuosien varrella satoja lyhytelokuvia. Näistä valtaosa on kuvattu filmille, ja nykyäänkin Montaasissa tehdään elokuvia sekä filmille että digivideolle. Elokuvia syntyy sekä vuosittain järjestettävillä <a href="/toiminta">elokuvakursseilla</a> että niiden ulkopuolella.</p>
    </div>
  </article>

  <article class="column-row">
    <div class="container col-2">
      <h3 class="row-title">Historiaa</h3>
      <p>
    ...
    <div class="container col-2">
      <h3 class="row-title">Omaehtoista elokuvantekoa</h3>
      <p>
