<footer id="main-footer">
  <div class="row">
    <div class="column medium-10 medium-centered">
      <p id="copy">
        <a href="<?php echo home_url(); ?>">Teekkarien elokuvakerho Montaasi ry</a><br>
        <a href="mailto:montaasi@list.ayy.fi" class="mail-link">montaasi@list.ayy.fi</a><br>
        <a href="https://www.facebook.com/montaasi" class="facebook-link">Montaasi Facebookissa</a>
        <a href="http://vimeo.com/montaasi" class="vimeo-link">Montaasi Vimeossa</a>
        <br>
...
<article id="saannot" class="overlay-content">
  <h3 class="featurette-title">Teekkarien elokuvakerho Montaasi ry:n kalustonvuokraussäännöt</h3 class="featurette-title">
